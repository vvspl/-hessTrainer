...
class Header extends Component {
  render() {
    const rightButtons = (
      <div>
        <IconButton title="New Game" onClick={this.props.requestOpenNewGame}>
    ...
    return (
      <div>
        <AppBar title="Chess" zDepth={0} iconElementRight={rightButtons}></AppBar>
        <LinearProgress id="thinking-bar" style={{ backgroundColor: '#333' }} mode="indeterminate">
          {' '}
        </LinearProgress>
      </div>
    );
